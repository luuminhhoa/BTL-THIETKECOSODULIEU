...
FS-3. \textbf{Đồng bộ trạng thái On-chain/Off-chain:} Lắng nghe và đồng bộ trạng thái giao dịch từ Sui blockchain về cơ sở dữ liệu quan hệ cục bộ (PostgreSQL).
