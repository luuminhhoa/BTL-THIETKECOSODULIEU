...
\begin{table}[H]
    ...
    \begin{tabular}{|c|l|p{8cm}|}
        ...
        FS-1 & AI Agent/SDK & Truy vấn ngữ cảnh tự động (MCP Context Retrieval) \\ \hline
        FS-2 & AI Agent/SDK & Ghi nhận giao dịch thời gian thực (Sub-100ms) \\ \hline
        FS-3 & AI Agent/SDK & Đồng bộ trạng thái On-chain và Off-chain \\ \hline
    \end{tabular}
\end{table}