...
\begin{description}
    ...
    \item[BR-5 Ràng buộc Mã băm Blockchain:] Giao dịch đã đồng bộ On-chain phải lưu trữ mã băm đối soát (sui\_tx\_digest) dưới dạng duy nhất (UNIQUE) trên cơ sở dữ liệu để phục vụ kiểm toán.
\end{description}
