...
\begin{itemize}
    ...
    \item \texttt{Email} (UNIQUE): Email đăng nhập hệ thống.
    \item \texttt{PasswordHash}: Mật khẩu đã được mã hóa.
\end{itemize}
...
\begin{itemize}
    ...
    \item \texttt{WalletAddress} (UNIQUE): Địa chỉ blockchain (Sui Network) được hệ thống sử dụng để định danh thông qua cơ chế Walletless Authentication.
