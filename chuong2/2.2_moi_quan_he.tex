...
\begin{itemize}
    ...
    \item \textbf{Campaign - CreditTransaction (1:N):} Các giao dịch cộng điểm (CreditTransaction) có thể được sinh ra từ việc áp dụng một chiến dịch (Campaign) cụ thể. Một chiến dịch thành công sẽ tạo ra rất nhiều giao dịch điểm cho khách hàng.
\end{itemize}
