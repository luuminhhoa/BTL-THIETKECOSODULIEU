...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[>=stealth, thick]
        ...
        \node[weak_entity] (transaction) at (0, -3) {CreditTransaction};
        ...
        \node[weak_relationship] (ghinhan) at (0, 0) {Ghi nhận}; 
        ...
        \draw (campaign) -- node[right, pos=0.4] {1} (apdung);
        ...
        % User
        \node[attribute] (u1) at (-10.5, 9.5) {\underline{UserID}};
        \node[attribute] (u2) at (-8, 9.5) {Email};
        \node[attribute] (u3) at (-5.5, 9.5) {RoleID};
        \node[attribute] (u4) at (-10.5, 6.5) {PasswordHash};
