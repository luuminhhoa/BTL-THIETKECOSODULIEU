...
\begin{description}
    ...
    \item[\texttt{User}] (\underline{UserID}, \textit{MerchantID}, Email, PasswordHash, RoleID)
...
Tập quan hệ này sẽ làm đầu vào cho mô hình toán học để tìm tập phụ thuộc hàm và chứng minh đạt dạng chuẩn ở phần tiếp theo.