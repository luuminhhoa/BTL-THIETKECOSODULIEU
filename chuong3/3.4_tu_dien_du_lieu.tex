...
\begin{table}[H]
    ...
    \begin{tabular}{|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{3.2cm}|>{\raggedright\arraybackslash}p{2.5cm}|>{\raggedright\arraybackslash}p{5.5cm}|}
        ...
        Status & VARCHAR(20) & NOT NULL & Trạng thái (Active, Paused, Ended). \\ \hline
    \end{tabular}
\end{table}
...
\textit{Ghi chú:} Các bảng còn lại (REWARD\_RULE, CREDIT, API\_CREDENTIAL) được thiết kế với cấu trúc kiểu dữ liệu tương tự, đảm bảo tuân thủ chặt chẽ các ràng buộc tham chiếu khóa ngoại đã định nghĩa ở Sơ đồ Logic (Mục 3.3).