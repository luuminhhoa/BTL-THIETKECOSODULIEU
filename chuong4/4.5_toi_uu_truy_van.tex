...
Khi đó, hệ thống sẽ ưu tiên sử dụng thuật toán \textbf{Nested-Loop Join} nhờ việc bảng \texttt{CAMPAIGN} (bảng trong) đã trở nên rất nhỏ và có thể nạp toàn bộ vào bộ nhớ đệm (Buffer pool). Nếu kích thước bảng trung gian lớn và không có thứ tự, hệ thống có thể cân nhắc chuyển sang \textbf{Hash Join} để đạt chi phí $O(b_R + b_S)$.