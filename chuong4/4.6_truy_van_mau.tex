...
\end{lstlisting}
MerchantID giúp phân biệt các cửa hàng trùng BusinessName. Mỗi dòng là số dư tại một cửa hàng; không cộng các ví thành số dư dùng chung.
...
ORDER BY TotalPointsIssued DESC, camp.CampaignID;
\end{lstlisting}
...
CampaignID được hiển thị cùng CampaignName để phân biệt các chiến dịch trùng tên; mỗi dòng kết quả vẫn tương ứng với một chiến dịch.

Truy vấn 3 sắp xếp tổng điểm phát hành giảm dần; nếu bằng nhau thì sắp xếp theo CampaignID để kết quả có thứ tự ổn định.
